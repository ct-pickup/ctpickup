                  ...
                  <div className="grid gap-3">
                    {data.planning?.slotCounts?.length ? (
                      data.planning.slotCounts.map((s: any) => {
                        const picked =
                          data.planning?.my_availability?.slot_id === s.slot_id &&
                          data.planning?.my_availability?.state === "available";
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-center justify-between gap-4">
                              <div className="text-sm font-semibold text-white/90">{fmt(s.start_at)}</div>
