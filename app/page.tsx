    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <div className="mx-auto max-w-6xl px-6 pt-6">
        <div className="rounded-full bg-white/90 px-6 py-3 text-black flex items-center justify-between">
          {/* Replace CT with Competitive Together (same size/color) */}
          <div className="font-semibold tracking-wide uppercase">
            COMPETITIVE · TOGETHER
          </div>

          <div className="flex items-center gap-6">
            <Link href="/status" className="text-sm font-medium tracking-wide">
              STATUS
            </Link>
      ...
      <div className="mx-auto max-w-6xl px-6">
        <section className="relative mt-10 flex min-h-[72vh] items-center justify-center">
          ...
          <div className="relative w-full max-w-xl text-center">
            ...
            {/* P I C K U P under the logo */}
            <div className="mt-6 text-white uppercase font-semibold tracking-[0.9em] text-2xl md:text-3xl">
              P I C K U P
            </div>

            {/* Remove Competitive Together from center; keep only Select/Public */}
            ...
            <div className="mt-6 flex items-center justify-between text-sm text-white/85">
              ...
              <Link href="/status" className="underline font-semibold">
                View Status
              </Link>
            </div>

            <div className="mt-12 text-xs font-semibold uppercase tracking-widest text-white/60">
              SCROLL
            </div>
          </div>
        </section>
