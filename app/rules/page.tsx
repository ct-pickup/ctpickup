      ...
      <div className="mx-auto max-w-5xl px-6 py-14 space-y-10">
        ...
        <section className="rounded-2xl border border-white/10 bg-white/[0.03] p-10 space-y-4">
          ...
          <div className="space-y-3 text-white/80">
            <p>CT Pickup is intended for college players, former college players, and high-level club players (ECNL, MLS Next).</p>
            <p>Minimum age: 16.</p>
        ...
        <section className="rounded-2xl border border-white/10 bg-white/[0.03] p-10 space-y-4">
          <div className="text-sm font-semibold uppercase tracking-wide text-white/70">BEHAVIOR</div>
          <div className="space-y-3 text-white/80">
            ...
            <p><span className="font-semibold text-white/90">Slide tackles are strictly prohibited.</span> Violators will be removed and not invited to return.</p>
          </div>
        </section>

        <div className="pt-2">
          <Link href="/help#questions" className="underline text-white/80">FAQ</Link>
        </div>
      </div>
    </main>
  );
