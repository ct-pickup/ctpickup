...
const s = StyleSheet.create({
  ...
  label: { fontSize: 11, fontWeight: "700", letterSpacing: 1.2, color: "rgba(255,255,255,0.45)", marginBottom: 8, textTransform: "uppercase" },
  input: { backgroundColor: "rgba(255,255,255,0.07)", borderRadius: 10, borderWidth: 1, borderColor: "rgba(255,255,255,0.12)", color: "#fff", paddingHorizontal: 14, paddingVertical: 12, fontSize: 15, minHeight: 80, textAlignVertical: "top" },
  hint: { color: "rgba(255,255,255,0.35)", fontSize: 12, marginTop: 8, lineHeight: 18 },
  ...
  footer: { color: "rgba(255,255,255,0.3)", fontSize: 12, textAlign: "center", marginTop: 16, lineHeight: 18 },
});
