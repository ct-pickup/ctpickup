      ...
      <View style={[styles.flex, styles.screen]}>
        ...
        >
          <Text style={styles.supportText}>
            Email us at{" "}
            <Text style={styles.supportLink} onPress={() => void Linking.openURL(SUPPORT_MAILTO)}>
              {SUPPORT_EMAIL}
            </Text>
          </Text>
        ...
        <View style={[styles.composer, { paddingBottom: 12 + insets.bottom }]}>
          ...
          <Text style={styles.aiDisclaimer}>
            Responses are generated by AI and may not always be accurate. For urgent issues contact{" "}
            <Text style={styles.supportLink} onPress={() => void Linking.openURL(SUPPORT_MAILTO)}>
              {SUPPORT_EMAIL}
            </Text>
          </Text>
