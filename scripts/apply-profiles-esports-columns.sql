-- One-shot: add missing profiles esports + goalie columns (fixes signup/profile when migrations were not applied).
-- Run in Supabase Dashboard → SQL Editor → paste → Run.
-- Idempotent: safe to run more than once.
--
-- Same logic as supabase/migrations/20260415120000_profiles_esports_online_id.sql
